...
import useStylesRectaPasaPorDosPuntos from "./RectaPasaProDosPuntosStyle";

const RectaPasaPorDosPuntos = ({p1 = {x:0, y:0}, p2 = {x:0, y:0}}) => {
    // STATE:
    ...
    const classes = useStylesRectaPasaPorDosPuntos(props);
...
export default RectaPasaPorDosPuntos;